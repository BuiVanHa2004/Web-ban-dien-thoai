...
public class AiAdvisorService {
    ...
    public AiResponse compare(List<Integer> productIds, String question) {
        ...
        String systemPrompt = "Bạn là chuyên gia so sánh điện thoại của MyPhone Store với kiến thức chuyên sâu về phần cứng. "
                + "Hãy SO SÁNH chi tiết " + productCount + " sản phẩm theo đúng cấu trúc 5 khía cạnh với KẾT LUẬN sau mỗi mục và tổng kết cuối cùng. "
                ...
                + "\n➡️ *Kết luận:* [Tên SP] hợp lý hơn về giá / [Tên SP] đắt hơn nhưng xứng đáng."
                ...
                + "\n➡️ *Kết luận:* [Tên SP] mạnh hơn cho gaming / [Tên SP] cân bằng cho đa nhiệm."
                + "\n\n📸 **Chụp ảnh & Camera**"
                ...
                + "\n➡️ *Kết luận:* [Tên SP] màn hình tốt hơn / Cả hai tương đương."
                + "\n\n🏆 **Tổng kết & Gợi ý**"
                ...
                + "\n- BẮT BUỘC: Sau MỖI mục so sánh (Giá, Hiệu năng, Camera, Pin, Màn hình) phải có KẾT LUẬN ngắn gọn (1 câu) về sản phẩm nào tốt hơn ở khía cạnh đó."
                ...
                + "\n- Tổng số từ của toàn bộ so sánh phải dưới 400 từ (tăng từ 350 để chứa kết luận)."
                + "\n- BẮT BUỘC CHỈ PHẢN HỒI JSON: Bạn CHỈ ĐƯỢC PHÉP trả về một đối tượng JSON hợp lệ duy nhất, tuyệt đối không viết thêm lời dẫn, không bọc trong ký tự markdown như ```json. "
                + "Đối tượng JSON có cấu trúc chính xác như sau:\n"
                + "{\n"
