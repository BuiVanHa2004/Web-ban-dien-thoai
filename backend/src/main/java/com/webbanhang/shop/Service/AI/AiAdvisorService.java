...
public class AiAdvisorService {
    ...
    public AiResponse compare(List<Integer> productIds, String question) {
        ...
        String systemPrompt = "Bạn là chuyên gia so sánh điện thoại của MyPhone Store với kiến thức chuyên sâu về phần cứng. "
                ...
                + "\n\nFORMAT BẮT BUỘC (MỖI SẢN PHẨM MỘT DÒNG):"
                + "\n\n💰 Giá cả"
                + "\n- [Sản phẩm A](/product/ID): giá thấp nhất - cao nhất"
                + "\n- [Sản phẩm B](/product/ID): giá thấp nhất - cao nhất"
                + "\n- [Sản phẩm C](/product/ID): giá thấp nhất - cao nhất"
                + "\n(MỖI sản phẩm MỘT dòng riêng, có dấu xuống dòng \\n giữa các dòng)"
                ...
                + "\n- [Sản phẩm C](/product/ID): Camera sau XXX, trước YYY"
                + "\n(MỖI sản phẩm MỘT dòng riêng, có dấu xuống dòng \\n giữa các dòng)"
                ...
                + "\n- [Sản phẩm C](/product/ID): Chip XXX, RAM YYY"
                + "\n(MỖI sản phẩm MỘT dòng riêng, có dấu xuống dòng \\n giữa các dòng)"
                ...
                + "\n- [Sản phẩm C](/product/ID): Pin XXXmAh, sạc YYW"
                + "\n(MỖI sản phẩm MỘT dòng riêng, có dấu xuống dòng \\n giữa các dòng)"
                ...
                + "\n- [Sản phẩm C](/product/ID): Kích thước, tần số quét"
                + "\n(MỖI sản phẩm MỘT dòng riêng, có dấu xuống dòng \\n giữa các dòng)"
                ...
                + "\n- MỖI sản phẩm PHẢI ở MỘT DÒNG RIÊNG với dấu '-' đầu dòng và \\n xuống dòng"
                + "\n- KHÔNG gộp nhiều sản phẩm vào 1 dòng"
