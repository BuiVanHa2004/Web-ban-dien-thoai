...
public record ProductEvaluateCommentDto(
        Integer evaluateId,
        Integer productId,
        String customerName,
        Integer rating,
    ...
    public static ProductEvaluateCommentDto fromEntity(Evaluate evaluate) {
        return fromEntity(evaluate, List.of(), null, null);
    }

    public static ProductEvaluateCommentDto fromEntity(Evaluate evaluate, List<EvaluateImage> images) {
        return fromEntity(evaluate, images, null, null);
    }

    public static ProductEvaluateCommentDto fromEntity(Evaluate evaluate, List<EvaluateImage> images, EvaluateReply reply) {
        return fromEntity(evaluate, images, reply, null);
    }

    public static ProductEvaluateCommentDto fromEntity(Evaluate evaluate, List<EvaluateImage> images, EvaluateReply reply, OrderItem orderItem) {
        ...
        return new ProductEvaluateCommentDto(
