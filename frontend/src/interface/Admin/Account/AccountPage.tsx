          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-5">
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <div className="text-xs font-semibold text-white/50 uppercase tracking-wide">Đăng nhập Google</div>
                    <div className="mt-1 text-sm text-white/85">{selectedAccount.googleId ? "Có" : "Không"}</div>
                  </div>
                  <div>
            ...
            >
              <button
                type="button"
                onClick={() => setSelectedAccount(null)}
                className="inline-flex cursor-pointer h-11 items-center justify-center rounded-2xl px-4 py-2 text-sm font-semibold text-white/85 shadow-sm transition hover:-translate-y-0.5 active:translate-y-0"
                style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)" }}
              >
                Đóng
              </button>
