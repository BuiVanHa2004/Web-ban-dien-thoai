      ...
      <div className="overflow-hidden rounded-[2.5rem] border border-slate-200/60 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="p-8 border-b border-slate-100 dark:border-slate-800 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <h3 className="text-xl font-black text-slate-900 dark:text-white flex items-center gap-3">
            <div className="rounded-xl p-2 bg-indigo-50 dark:bg-indigo-900/20">
              <ImageIcon className="h-5 w-5 text-indigo-600 dark:text-indigo-400" />
            </div>
            {attemptStatusFilter === "WAITING_CONFIRM"
              ? "Hàng đợi xử lý minh chứng"
              : attemptStatusFilter === "MATCHED"
              ? "Lịch sử đã duyệt thành công"
              : "Lịch sử đã từ chối"}
            <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
            {attempts.length > 0 && (
              <span className="flex h-6 min-w-[24px] items-center justify-center rounded-full px-2 text-[10px] font-black bg-indigo-600 text-white">
                {attempts.length}
              </span>
            )}
          </h3>
            ...
            {showDetailModal && selectedAttempt && (
              <div className="fixed inset-0 flex items-center justify-center p-4" style={{ zIndex: 99999 }}>
                ...
                <motion.div
                  ...
                  className="relative w-full max-w-6xl rounded-[3rem] flex flex-col lg:flex-row max-h-[90vh]"
                  style={{
                ...
                >
                  {/* Left panel: Image */}
                  <div
                    className="lg:w-1/2 p-8 flex flex-col items-center justify-center overflow-y-auto rounded-l-[3rem]"
                    style={{
                  ...
                  <div className="flex-1 flex flex-col overflow-hidden rounded-r-[3rem]">
                    {/* Sticky header */}
                    <div
                    ...
                    >
                      <div>
                        <h2 className="text-3xl font-black tracking-tight text-white">Xử lý phê duyệt</h2>
                        <div className="flex items-center gap-2 mt-1">
                          <span className="text-sm font-bold text-white/70">Đơn hàng:</span>
                          <span className="text-sm font-black text-indigo-400">ĐH-{selectedAttempt.orderId}</span>
                        </div>
                      </div>
                      <button
                        onClick={() => setShowDetailModal(false)}
                    ...
                    <div className="flex-1 overflow-y-auto p-10 flex flex-col">
                      ...
                      <div
                        className="mb-8 p-6 rounded-[2rem] flex gap-4"
                        style={{
                      ...
                      >
                        ...
                        {(selectedAttempt.status === "MATCHED" || selectedAttempt.status === "REJECTED") && (
                          <div
                            className={`p-6 rounded-[2rem] border flex gap-4 items-center ${
                          ...
                          (() => {
                            ...
                            return (
                              <>
                                {isStaffRestricted && (
                                  <div
                                    className="mb-6 p-6 rounded-[2rem] flex gap-4 items-center"
                                    style={{
                                ...
                                (!selectedAttempt.lockExpiresAt ||
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <button
                                      ...
                                      disabled={processing || isStaffRestricted}
                                      className="h-16 rounded-2xl font-black transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-rose-400"
                                      style={{
                                    ...
                                    <button
                                      ...
                                      disabled={processing}
                                      className="md:col-span-2 h-14 rounded-2xl font-black transition-all flex items-center justify-center gap-2 text-white/60 hover:text-white/85"
                                      style={{
                                        background: "rgba(255,255,255,0.06)",
                                        border: "1px solid rgba(255,255,255,0.1)",
                                      }}
