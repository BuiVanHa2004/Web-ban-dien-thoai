    ...
    <div className="mx-auto max-w-6xl space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-white/60 text-slate-800 ring-1 ring-slate-200/70 shadow-sm backdrop-blur-xl dark:bg-white/5 dark:text-slate-100 dark:ring-white/10">
