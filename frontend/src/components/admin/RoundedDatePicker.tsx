...
export function RoundedDatePicker({ 
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 z-50 px-3 sm:px-0 sm:right-auto">
          {/* Calendar popup */}
          <div className="relative rounded-2xl bg-white border border-slate-200 shadow-xl dark:bg-slate-800 dark:border-slate-700 overflow-hidden w-full sm:w-[320px]">
            {/* Header */}
